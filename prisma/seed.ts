...
async function main() {
  ...
  await prisma.$executeRaw`
    ...
    VALUES
    -- Project 1 
    (0, 0, 1, 1, 'Set up NextJs', 'Set up NextJs for the project', 100, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 3, 1, 1, 1, null),
    (1, 1, 1, 2, 'Create SQL schema', 'Create SQL schema for the project', 100, NOW() + INTERVAL 2 DAY, NOW(), NOW(), 3, 1, 1, 2, null),
    (2, 2, 2, 3, 'Develop the homepage', 'Develop the homepage with a simple design', 100, NOW() + INTERVAL 3 DAY, NOW(), NOW(), 3, 1, 1, 3, null),
    (3, 3, 1, 1, 'Set up NestJs', 'Set up NestJs for the project', 100, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 3, 1, 1, 4, null),
    (4, 4, 2, 2, 'Fix the bug in the register page', 'The register page is not working properly', 100, NOW() + INTERVAL 5 DAY, NOW(), NOW(), 3, 1, 1, 5, null),
    (5, 5, 2, 3, 'Develop the dashboard', 'Develop the dashboard with a simple design', 100, NOW() + INTERVAL 6 DAY, NOW(), NOW(), 3, 1, 1, 6, null),
    (0, 0, 1, 1, 'Implement NextAuth', 'Implement NextAuth in frontend for the project', 50, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 2, 3, 1, 1, null),
    (1, 1, 1, 1, 'Handle user authentication', 'Handle user authentication in the backend', 50, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 2, 3, 1, 1, null),
    (2, 2, 2, 4, 'Test the login page', 'Test the login page with different scenarios',  50, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 2, 3, 1, 1, 8),
    (0, 3, 2, 4, 'Test the register page', 'Test the register page with different scenarios', 0, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 1, 3, 1, 1, 8),
    (1, 4, 2, 1, 'Develop the profile page', 'Develop the profile page with a simple design', 0, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 1, 3, 1, 1, null),
    (2, 5, 2, 2, 'Fix the bug in the dashboard', 'The dashboard is not working properly', 0, NOW() + INTERVAL 5 DAY, NOW(), NOW(), 1, 3, 1, 1, null),
    (3, 0, 2, 1, 'Write CRUD API for user', 'Write CRUD API for user in the backend', 0, null, NOW(), NOW(), 1, 4, 1, 1, null),
    (4, 1, 2, 1, 'Write CRUD API for project', 'Write CRUD API for project in the backend', 0, null, NOW(), NOW(), 1, 4, 1, 1, null),
    (5, 2, 2, 1, 'Write CRUD API for issue', 'Write CRUD API for issue in the backend', 0, null, NOW(), NOW(), 1, 4, 1, 1, null),
    ...
    (2, 4, 1, 1, 'Phát triển trang chủ', 'Phát triển trang chủ với thiết kế đơn giản', 50, NOW() + INTERVAL 3 DAY, NOW(), NOW(), 5, 7, 2, 2, null),
    (3, 5, 1, 1, 'Thiết lập NestJs', 'Thiết lập NestJs cho dự án', 50, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 5, 7, 2, 5, null),
    (4, 6, 1, 1, 'Phát triển Dashboard', 'Phát triển Dashboard với thiết kế đơn giản', 50, NOW() + INTERVAL 6 DAY, NOW(), NOW(), 5, 7, 2, 4, null),
    (0, 0, 1, 1, 'Thiết lập tính năng đăng nhập, đăng ký', 'Thiết lập tính năng đăng nhập, đăng ký cho dự án', 0, null, NOW(), NOW(), 4, 8, 2, 1, null),
    (1,1, 2, 4, 'Kiểm thử trang đăng nhập', 'Kiểm thử trang đăng nhập với các trường hợp khác nhau', 0, null, NOW(), NOW(), 4, 8, 2, 1, 31),
    (2,2,2,4, 'Xác thực người dùng', 'Xác thực người dùng ở phía backend', 0, null, NOW(), NOW(), 4, 8, 2, 1, 31),
    (3,3,2,4, 'Thiết kế trang đăng nhập', 'Thiết kế trang đăng nhập với thiết kế đơn giản', 0, null, NOW(), NOW(), 4, 8, 2, 1, 31),
    (4,4,2,4, 'Thiết lập trang đăng ký', 'Thiết kế trang đăng ký với thiết kế đơn giản', 0, null, NOW(), NOW(), 4, 8, 2, 1, 31),


    -- Project 3
  (0, 0, 1, 1, 'Thiết lập môi trường phát triển', 'Thiết lập môi trường phát triển', 100, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 7, 12, 3, 1, null),
  (1, 1, 1, 2, 'Xây dựng API', 'Xây dựng API cho dự án', 100, NOW() + INTERVAL 2 DAY, NOW(), NOW(), 7, 12, 3, 1, null),
  (2, 2, 2, 3, 'Phát triển giao diện người dùng', 'Phát triển giao diện người dùng', 100, NOW() + INTERVAL 3 DAY, NOW(), NOW(), 7, 12, 3, 1, null),
  (3, 3, 1, 1, 'Kiểm thử và sửa lỗi', 'Kiểm thử và sửa lỗi', 100, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 7, 12, 3, 1, null),
  (4, 4, 2, 2, 'Tạo trang giới thiệu', 'Tạo trang giới thiệu cho dự án', 100, NOW() + INTERVAL 5 DAY, NOW(), NOW(), 7, 12, 3, 1, null),
  (5, 5, 2, 3, 'Tích hợp hệ thống thông báo', 'Tích hợp hệ thống thông báo', 100, NOW() + INTERVAL 6 DAY, NOW(), NOW(), 7, 12, 3, 1, null),

  -- Project 4
  (0, 0, 1, 1, 'Thiết lập cấu trúc cơ bản', 'Thiết lập cấu trúc cơ bản', 100, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 10, 17, 4, 4, null),
  (1, 1, 1, 2, 'Phát triển tính năng chính', 'Phát triển tính năng chính của dự án', 100, NOW() + INTERVAL 2 DAY, NOW(), NOW(), 10, 17, 4, 1, null),
  (2, 2, 2, 3, 'Tối ưu hóa hiệu suất', 'Tối ưu hóa hiệu suất', 100, NOW() + INTERVAL 3 DAY, NOW(), NOW(), 10, 17, 4, 2, null),
  (3, 3, 1, 1, 'Đảm bảo an ninh', 'Đảm bảo an ninh cho dự án', 100, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 10, 17, 4, 3, null),
  (4, 4, 2, 2, 'Viết tài liệu hướng dẫn', 'Viết tài liệu hướng dẫn', 100, NOW() + INTERVAL 5 DAY, NOW(), NOW(), 10, 17, 4, 5, null),
  (5, 5, 2, 3, 'Triển khai dự án', 'Triển khai dự án lên server', 100, NOW() + INTERVAL 6 DAY, NOW(), NOW(), 10, 17, 4, 6, null),

  -- Project 5
  (0, 0, 1, 1, 'Initial Setup and Configuration', 'Initial Setup and Configuration', 100, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 13, 22, 5, 1, null),
  (1, 1, 1, 2, 'Build Main Application Features', 'Build Main Application Features', 100, NOW() + INTERVAL 2 DAY, NOW(), NOW(), 13, 22, 5, 1, null),
  (2, 2, 2, 3, 'Optimize Performance', 'Optimize Performance', 100, NOW() + INTERVAL 3 DAY, NOW(), NOW(), 13, 22, 5, 1, null),
  (3, 3, 1, 1, 'Write User Documentation', 'Write User Documentation', 100, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 13, 22, 5, 1, null),
  (4, 4, 2, 2, 'Deploy the Application', 'Deploy the Application', 100, NOW() + INTERVAL 5 DAY, NOW(), NOW(), 13, 22, 5, 1, null),
  (5, 5, 2, 3, 'Test the Application', 'Test the Application', 100, NOW() + INTERVAL 6 DAY, NOW(), NOW(), 13, 22, 5, 1, null),

  -- Project 6
  (0, 0, 1, 1, 'Define Project Scope', 'Define Project Scope', 100, NOW() + INTERVAL 1 DAY, NOW(), NOW(), 16, 25, 6, 1, null),
  (1, 1, 1, 2, 'Develop Core Modules', 'Develop Core Modules', 100, NOW() + INTERVAL 2 DAY, NOW(), NOW(), 16, 25, 6, 1, null),
  (2, 2, 2, 3, 'Optimize Performance', 'Optimize Performance', 100, NOW() + INTERVAL 3 DAY, NOW(), NOW(), 16, 25, 6, 1, null),
  (3, 3, 1, 1, 'Write User Documentation', 'Write User Documentation', 100, NOW() + INTERVAL 4 DAY, NOW(), NOW(), 16, 25, 6, 1, null),
  (4, 4, 2, 2, 'Deploy the Application', 'Deploy the Application', 100, NOW() + INTERVAL 5 DAY, NOW(), NOW(), 16, 25, 6, 1, null),
  (5, 5, 2, 3, 'Test the Application', 'Test the Application', 100, NOW() + INTERVAL 6 DAY, NOW(), NOW(), 16, 25, 6, 1, null);
